...
$(window).load(function() {
  ...
  if ($(".product_filter").length) {
    var $container = $(".isotope_products_items");
    $container.isotope();

    $(".product_filter ul li").on("click", function() {
      $(".product_filter ul li").removeClass("select-cat");
      $(this).addClass("select-cat");
      var selector = $(this).attr("data-filter");
      initPrducts(selector);
      return false;
    });
  }

  function initPrducts(selector) {
    $(".isotope_products_items").isotope({
      filter: selector,
      animationOptions: {
        duration: 750,
        easing: "linear",
